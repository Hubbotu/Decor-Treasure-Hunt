...
local QUEST_DATA = {
    ...
    [93079] = {name="Iron-Reinforced Door",            uiMapID=2351, x=0.635, y=0.488},
    [93080] = {name="Iron-Studded Wooden Window",      uiMapID=2351, x=0.653, y=0.580},
    [93081] = {name="Orgrimmar Chair",                 uiMapID=2351, x=0.720, y=0.500},
    ...
    [93141] = {name="Elegant Elven Chandelier",        uiMapID=2351, x=0.505, y=0.796},
    ...
    [93150] = {name="Elegant Wooden Dresser",          uiMapID=2351, x=0.446, y=0.576},
